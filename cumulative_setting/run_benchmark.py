...
from dynamic_cheatsheet.utils.evaluation import eval_sudoku,eval_for_GameOf24, eval_for_multiple_choice, eval_for_exact_matching_with_no_punctuation, eval_equation_balancer
...
PvP_PREDEFINED_PROMPTS = {
    "TwentyQuestion": "You are playing the game Five Question. You will be given 10 candidate words. One of them is the answer word. You can ask up to 5 yes/no questions to identify the answer word. You will get a Yes, No, or Invalid answer for each question."
}
...
def main(args):
    ...
    if args.task in PREDEFINED_PROMPTS and args.task not in ['Sudoku',"TwentyQuestion","P3_Test"]:
        ...
        file_path = "data/twentyQuestion/word=10_question=5_count=600.jsonl"
        dataset = []
